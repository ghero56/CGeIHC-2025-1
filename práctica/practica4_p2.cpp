...
int main()
{
	...
	*/
	...
	while (!mainWindow.getShouldClose())
	{
		...
		// inicializamos color para evitar errores
		...
		meshList[2]->RenderMeshGeometry(); //dibuja cubo y pir�mide triangular
		...
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		sp.render(); //dibuja cubo y pir�mide triangular

		// visor
		model = modelaux2;
		model = glm::translate(model, glm::vec3(0.05f, 1.f, 1.f));
		...
		model = modelaux2 = modelaux; // reiniciamos todos los padres de la jerarquia a la base del robot
		// extremidades 
		//brazo 1
		// articulación 1
		...
		//rotaci�n alrededor de la articulaci�n que une con la base
		...
		model = modelaux = modelaux2; // reiniciamos todos los padres de la jerarquia a la base del robot
		// extremidades 
		//brazo 2
		// articulación 1
		model = glm::translate(model, glm::vec3(-1.5f, -0.5f, -1.5f));

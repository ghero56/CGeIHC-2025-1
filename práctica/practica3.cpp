...
void CrearCaraDerechaInvertida()
{
...
void CrearCaraIzquierdaInvertida()
{
...
int main()
{
	...
	// inicialmente tiene 5
	CrearCilindro(4, 1.0f);//índice 2 en MeshList
	CrearCono(25, 2.0f);//índice 3 en MeshList
	CrearPiramideCuadrangular();//índice 4 en MeshList
	CrearCaraDerechaInvertida();//índice 5 en MeshList
	CrearCaraIzquierdaInvertida();
	CreateShaders();
	...
	while (!mainWindow.getShouldClose())
	{
		...
		// conjunto de primera cara de piramides rojas
		// top
		model = glm::mat4(1.0);
		...
		// conjunto de segunda cara de piramides azules
		// top
		model = glm::mat4(1.0);
		...
		// conjuntos de tercer cara de piramides verdes
		//top
		model = glm::mat4(1.0);
		...
		color = glm::vec3(0.0f, 1.0f, 0.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
		// renderizado de solamente la cara
		...
		// conjuntos de cuarta cara de piramides amarillas
		//top
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(-0.05f, 6.8f, -.01f));
		model = glm::scale(model, glm::vec3(3.0f, 3.0f, 3.0f));
		...
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(-0.3f, 3.4f, 0.00f));
		model = glm::scale(model, glm::vec3(3.0f, 3.0f, 3.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(1.0f, 1.0f, 0.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
